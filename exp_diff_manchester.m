function [ out8bit, snr, err_pcm ] = exp_diff_manchester( in8bit, noise, vp, nb, R )
%EXP_DIF_MANCHASTER: 256-PAM -> PCM -> Diff. Manchester Mod -> Channel ->
%                            -> Diff. Manchester Demod -> PCM -> 256-PAM.
%   INPUT -----------------------------------------------------
